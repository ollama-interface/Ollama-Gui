...
import { X, Server, Trash2, Database, Download, BarChart3 } from "lucide-react";
import { siX, siGithub } from "simple-icons";
import { getDatabaseStats, DatabaseStats } from "@/core/database-actions";
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 mb-3">
                      Clear all conversations and messages from your local
                      database.
                    </p>
                    {!showClearConfirm ? (
                      <Button
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Display performance metrics (duration, tokens, speed)
                      below AI responses
                    </p>
                  </div>
                </div>
